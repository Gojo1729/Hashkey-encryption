...
async def DHKE_customer_1(data: Request):
    if broker_state.auth_done:
        ...
        if "DHKE" == receieved_data["TYPE"]:
            ...
            logger.critical(f"Calculated Customer 1 - Broker DH session key {broker_state.dh_shared_key}")
            print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
...
async def message_customer_1(data: Request):
    ...
    # viewing products
        ...
        logger.critical(f"Merchant keys {merchant_state.iv}, {merchant_state.session_key}")
        print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++") 
